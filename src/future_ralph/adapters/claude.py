...
class ClaudeAdapter(BaseAdapter):
    def detect(self) -> Dict[str, Any]:
        ...
        return {"found": False, "binary_path": None, "version": None, "notes": ["claude CLI not found in PATH"]}
